...
import com.slack.kaldb.logstore.columnar.util.ReflectionUtil;
import com.slack.secor.protobuf.Messages.UnitTestMessage3;
...
public class ProtobufParquetFileReaderWriterFactoryTest extends TestCase {
  ...
  public void testProtobufParquetReadWriteRoundTrip() throws Exception {
    ...
    FileWriter fileWriter =
        ReflectionUtil.createFileWriter(
            config.getFileReaderWriterFactory(), tempLogFilePath, null, config);

    UnitTestMessage3 msg1 =
        UnitTestMessage3.newBuilder().setData("abc").setTimestamp(1467176315L).build();
    UnitTestMessage3 msg2 =
        UnitTestMessage3.newBuilder().setData("XYZ").setTimestamp(1467176344L).build();
  ...
  public void testJsonParquetReadWriteRoundTrip() throws Exception {
    ...
    UnitTestMessage3 protomsg1 =
        UnitTestMessage3.newBuilder().setData("abc").setTimestamp(1467176315L).build();
    UnitTestMessage3 protomsg2 =
        UnitTestMessage3.newBuilder().setData("XYZ").setTimestamp(1467176344L).build();
