...
public class RecoveryTaskAssignmentServiceTest {
  ...
  public void setup() throws Exception {
    ...
    recoveryTaskMetadataStore = new RecoveryTaskMetadataStore(metadataStore, true);
    recoveryNodeMetadataStore = new RecoveryNodeMetadataStore(metadataStore, true);
  }
  ...
  public void shouldHandleNodesAvailableFirst() throws Exception {
    RecoveryTaskAssignmentService recoveryTaskAssignmentService =
        new RecoveryTaskAssignmentService(
            recoveryTaskMetadataStore, recoveryNodeMetadataStore, meterRegistry);
