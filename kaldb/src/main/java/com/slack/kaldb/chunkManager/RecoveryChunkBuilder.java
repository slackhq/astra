...
import com.slack.kaldb.chunk.RecoveryChunkImpl;
...
public class RecoveryChunkBuilder<T> implements ChunkBuilder<T> {
  ...
  @Override
  public ReadWriteChunk<T> build() throws IOException {
