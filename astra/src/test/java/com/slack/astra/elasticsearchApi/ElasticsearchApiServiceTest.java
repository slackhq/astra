...
public class ElasticsearchApiServiceTest {
  ...
  public void setUp() throws Exception {
    ...
    elasticsearchApiService =
        new ElasticsearchApiService(searcher, AstraConfigUtil.makeQueryConfig());
  }
  ...
  public void testResultsAreReturnedForValidQueryWithoutFullTextSearch() throws Exception {
    ...
    ElasticsearchApiService testElasticsearchApiService =
        new ElasticsearchApiService(testSearcher, AstraConfigUtil.makeQueryConfig());
  ...
  public void testLargeSetOfQueries() throws Exception {
    ...
    ElasticsearchApiService slowElasticsearchApiService =
        new ElasticsearchApiService(slowSearcher, AstraConfigUtil.makeQueryConfig());
